package com.sujin.mvvmsamplearchitecture.base
 ...
 */
abstract class BaseAdapter<T, VH : BaseViewHolder, B : ViewDataBinding> : RecyclerView.Adapter<VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) = onBindCustomViewHolder(holder, position)
